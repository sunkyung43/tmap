...
<script type="text/javascript">
	...
	function executeSave() {
		...
		$.post("dataTypeInfoInsert.do", $("#ContentsForm").serialize(),
				function(data) {
					alert(data.json.MESSAGE);

					$("#dataTypeId").val(data.json.dataTypeId);
		...
		<div id="bodyDiv">
			<div class="contentsDiv">
				<div class="contentDiv">
					<table>
						<tr>
							<td width="590"><img src="images/h3_ico.gif"><span>데이터
									타입관리 등록</span></td>
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="text" name="dataTypeContent"
									class="textbox" style="width: 400px;" title="내용"></td>
							</tr>
							<tr>
								<th>ETC</th>
										...
										<td valign="top" bgcolor="#FFFFFF">
											...
											<div id="contents" style="width: 850px">
												...
												<table width="750" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td class="ttl7">[DataType 정보 등록]</td>
															...
															<table width="748" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td class="ttl4"><input type="text"
																		name="dataTypeName" class="textbox validate-req"
															...
															<table width="748" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td class="ttl4"><input type="text" name="etc"
																		class="textbox" style="width: 600px" title="etc"
																		maxbyte="150" /></td>
																	<td width="5"></td>
																</tr>
															</table>
