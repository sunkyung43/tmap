...
<script>
	...
	function processIdDuplication() {
	    ...
	    $("#checkId").val($("#comCode").val());
	 	...
	 	//호출 및 메시지 출력
	    $.post("processCodeIdDuplication.do", $("#ContentsForm").serialize(), function(data) {
...
<body>
	<form name="ContentsForm" method="post" id="ContentsForm">
		<input type="hidden" id="checkId" name="checkId" value="" /> <input
			type="hidden" name="codeLevel" value="2" /> <input type="hidden"
			name="useState" value="Y" /> <input type="hidden" name="upComCode"
			value="${upComCode}" />
		...
		<div id="bodyDiv">
			<div class="contentsDiv">
				<div class="contentDiv">
					<table>
						<tr>
							<td width="600"><img src="images/h3_ico.gif"><span>소분류코드
									등록</span></td>
					...
					<table class="srvRegi">
						...
						<tr>
							...
							<td><input type="text" name="codeRemark" class="textbox"
								style="width: 620px; title="코드설명" maxlength="1000" /></td>
						</tr>
					</table>
							...
							<td align="center" background="images/box2.gif"><table
									...
									<tr>
										...
										<td><input type="text" name="comCode" id="comCode"
											class="textbox" style="width: 300" title="코드" maxlength="10" />
											<a id="anchIdDup"><img src="images/btn/checkid.gif"
												align="absmiddle" style="cursor: hand"></a>
									</tr>
									<tr>
								...
								<table width="748" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="10"></td>
										<td><input type="text" name="codeName"
											class="textbox validate-req" style="width: 600px" title="코드명"
											maxlength="20" /></td>
									</tr>
									<tr>
										<td height="1" colspan="4" bgcolor="#f3961d"></td>
								...
								<table width="748" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="10"></td>
										<td><input type="text" name="codeRemark" class="textbox"
											style="width: 600px" title="코드설명" maxlength="100" /></td>
									</tr>
								</table></td>
						</tr>
						<tr>
										...
										<td valign="top" bgcolor="#FFFFFF">
											...
											<div id="contents" style="width: 850px">
												<table border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td><img src="images/h3_ico.gif"><span></span></td>
														<td width="30"></td>
													</tr>
													<tr>
														<td height="10"></td>
